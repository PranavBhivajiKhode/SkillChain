...
const MessagesCenter = () => {
  ...
  const conversations = [
    {
      ...
      lastMessage: "Great work on the frontend! When can we expect the backend API?",
    ...
    },
    {
      ...
      lastMessage: "The mockups look fantastic! Just a few minor revisions needed.",
    ...
    },
    {
      ...
      lastMessage: "Yes, let's schedule a call for tomorrow at 2 PM EST.",
    ...
    },
    {
      ...
      lastMessage: "I'd like to discuss the color palette options.",
  ...
  const messages = {
    1: [
      ...
      },
      {
        id: 7,
        sender: "client",
        message: "Great work on the frontend! When can we expect the backend API?",
        timestamp: "2024-01-23 16:00",
        isRead: false,
      },
    ],
    2: [
    ...
    4: [
      {
        id: 1,
        sender: "freelancer",
        message: "Hello! I'm ready to discuss the brand identity design project.",
      ...
      },
      {
        id: 2,
        sender: "client",
        message: "I'd like to discuss the color palette options.",
  ...
  //                     >
  //                       <span className="text-white fw-bold small">{conversation.clientAvatar}</span>
  //                     </div>
  ...
  //                       <h6 className="mb-0 text-truncate">{conversation.clientName}</h6>
  ...
  //                   style={{ width: "40px", height: "40px" }}
  //                 >
  //                   <span className="text-white fw-bold small">{selectedConversationData?.clientAvatar}</span>
  //                 </div>
  ...
  //                 <h6 className="mb-0">{selectedConversationData?.clientName}</h6>
  ...
  //               <div
  //                 key={message.id}
  //                 className={`d-flex mb-3 ${message.sender === "freelancer" ? "justify-content-end" : ""}`}
  //               >
  //                 <div className={`max-width-75 ${message.sender === "freelancer" ? "order-2" : ""}`}>
  //                   <div
  //                     className={`p-3 rounded ${message.sender === "freelancer" ? "bg-primary text-white" : "bg-light"}`}
  //                   >
  //                     <p className="mb-0">{message.message}</p>
  //                   </div>
  //                   <small className={`text-muted d-block mt-1 ${message.sender === "freelancer" ? "text-end" : ""}`}>
  //                     {message.timestamp}
  //                   </small>
  //                 </div>
  //               </div>
